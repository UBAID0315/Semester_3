...
// ----------------------------------------------------------------------------------------
        ...
        Node* deletenode(Node* root,int value)
        {
            ...
            Node *searchNode = Search_Node(root,value);
            cout<<"Search by value: "<<searchNode<<endl;
            // if (searchNode->left && searchNode->right == NULL)
            // {
            //     return root;
            // }
            // else if ((searchNode->left == NULL && searchNode->right != NULL) || (searchNode->left != NULL && searchNode->right == NULL))
            // {
            //     Node *parent = findparent(searchNode,value);
            //     cout<<"parent: "<<parent->data<<endl;
            //     if (searchNode->left != NULL)
            //     {
            //         parent = searchNode->left;
            //         return searchNode;
            //     }
            //     parent = searchNode->right;
            //     return searchNode;
            // }
            // else if((root->left && root->right) != NULL)
            // {
            //     Node *left = Maximum_Node(root->left);
            //     Node *right = Maximum_Node(root->right);
            // }
            return NULL;
        }
...
int main()
{
    Node *root = NULL;
    Binary_Tree T;
    int bag_capacity,choose,val,choice;
